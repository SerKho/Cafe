...
import Cafe.Ingredients.Coffee;
...
public class BlackTea extends Product {
    ...
    public BlackTea(IngredientPriceList i){
        this(i,400, 15, 5);
    }
    public BlackTea(IngredientPriceList i, int waterAmount, int sugarAmount, int blackTeaAmount){
        name = "Black tea";
        this.i = i;
        ingredients[0] = new Water(waterAmount);
        ingredients[1] = new Sugar(sugarAmount);
        ingredients[2] = new Cafe.Ingredients.BlackTea(blackTeaAmount);
    ...
    public double countPrice() {
        return ingredients[0].getAmount()/i.getIPList()[0].getAmount()*i.getIPList()[0].getPrice()+
                ...
                ingredients[2].getAmount()/i.getIPList()[4].getAmount()*i.getIPList()[4].getPrice();
    }
}
